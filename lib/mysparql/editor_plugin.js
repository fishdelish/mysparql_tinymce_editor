...
MySparqlSetup.prototype.init = function(editor, url) {
  ...
  editor.addCommand('mceMysparql', function() {
    editor.windowManager.open( {file: url+"/dialog.htm", width:600, height:550, inline:1}, {plugin_url: url});
    },
    {plugin_url: url});
  ...
  editor.onNodeChange.add(function(ed, cm, n) {
    p = n.parentNode
    cm.setActive('mysparql', n.nodeName == 'A' && p.nodeName == "DIV" && /mysparql/.test(p.className));
  });
};
